...
public class CreditCardNumberTest {
    ...
    @Test
    public void throwsInvalidArgumentExceptionWhenCvcTooLong() {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    public void throwsInvalidArgumentExceptionWhenCvcIsNotANumber() {
        assertThrows(IllegalArgumentException.class, () -> {
            new CreditCardNumber("4321876532147654", "notANumber!");
        });
    }
}
